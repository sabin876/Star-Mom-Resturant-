...
const contentBg = '/content-bg.jpg';
const heroImages = [
        ...
        <>
          ...
          <section id="services" className="pahuna-ghar-info" style={{
            ...
            <div className="container" style={{ position: 'relative', zIndex: 2, maxWidth: '1000px', margin: '0 auto' }}>
              ...
              >
                <div style={{ 
                  width: '80px', height: '80px', borderRadius: '50% 50% 10% 50%', transform: 'rotate(45deg)', backgroundColor: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: '30px', boxShadow: '0 0 30px rgba(255,255,255,0.2)' 
                }}>
                  <div style={{ transform: 'rotate(-45deg)', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <Flame size={45} color="#1a1a1a" fill="#1a1a1a" strokeWidth={1} style={{ marginTop: '-4px', marginLeft: '-4px' }} />
                  </div>
                </div>
            ...
            <motion.div className="footer-col" variants={footerItem}>
              ...
              <ul style={{ color: 'rgba(255,255,255,0.7)', display: 'grid', gap: '20px' }}>
                ...
                <li style={{ display: 'flex', gap: '15px' }}>
                  ...
                  <span>+971 55 941 9176 (WhatsApp)</span>
                </li>
              </ul>
            </motion.div>
            <motion.div className="footer-col" variants={footerItem}>
