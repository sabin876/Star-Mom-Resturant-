...
const menuData = [
  ...
  },
  {
    category: 'Taas Set',
    items: [
      { name: 'Chicken Taas Set', price: '24 Dhs.', img: 'https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?q=80&w=800&auto=format&fit=crop' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Chewra Chicken Set', price: '16 Dhs.', img: 'https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?q=80&w=800&auto=format&fit=crop' },
  ...
  },
  {
    category: 'Khaja Set',
    items: [
      { name: 'Khaja Set Mushroom / Paneer Chilli', price: '20 Dhs.', img: 'https://images.unsplash.com/photo-1606491956689-2ea866880c84?q=80&w=800&auto=format&fit=crop' },
      { name: 'Khaja Set Chicken', price: '22 Dhs.', img: 'https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?q=80&w=800&auto=format&fit=crop' },
      { name: 'Khaja Set Buff (Sukuti / Chhoila)', price: '25 Dhs.', img: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?q=80&w=800&auto=format&fit=crop' },
  ...
  },
  {
    ...
    items: [
      { name: 'Veg.', price: '26 Dhs.', img: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=800&auto=format&fit=crop' },
      { name: 'Chicken', price: '28 Dhs.', img: 'https://images.unsplash.com/photo-1603894584373-5ac82b2ae39f?q=80&w=800&auto=format&fit=crop' },
      { name: 'Buff', price: '29 Dhs.', img: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?q=80&w=800&auto=format&fit=crop' },
    ],
  },
  {
    ...
    items: [
      ...
      { name: 'Thakali Mushroom', price: '23 Dhs.', img: 'https://images.unsplash.com/photo-1518014370036-b3e4b58820ff?q=80&w=800&auto=format&fit=crop' },
      { name: 'Thakali Chicken (Curry / Fried / Chilli)', price: '22 Dhs.', img: 'https://images.unsplash.com/photo-1585937421612-70a008356fbe?q=80&w=800&auto=format&fit=crop' },
      { name: 'Thakali Local Chicken Curry', price: '25 Dhs.', img: 'https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?q=80&w=800&auto=format&fit=crop' },
      { name: 'Thakali Buff Sukuti Fry', price: '25 Dhs.', img: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?q=80&w=800&auto=format&fit=crop' },
      { name: 'Thakali Mutton Curry', price: '25 Dhs.', img: 'https://images.unsplash.com/photo-1574653853027-5382a3d23a15?q=80&w=800&auto=format&fit=crop' },
      ...
      { name: 'Thakali Mutton Pakku', price: '29 Dhs.', img: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=80&w=800&auto=format&fit=crop' },
    ],
  },
  {
    category: 'Dhido Set',
    items: [
      ...
      { name: 'Thakali Dhido w/ Mushroom', price: '24 Dhs.', img: 'https://images.unsplash.com/photo-1518014370036-b3e4b58820ff?q=80&w=800&auto=format&fit=crop' },
      ...
      { name: 'Thakali Dhido w/ Local Chicken Curry', price: '28 Dhs.', img: 'https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?q=80&w=800&auto=format&fit=crop' },
  ...
  },
  {
    ...
    items: [
      { name: 'Laphing (Tibetan) - Dry', price: '15 Dhs.', img: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?q=80&w=800&auto=format&fit=crop' },
      ...
      { name: 'Spicy Platter', price: '30 Dhs.', img: 'https://images.unsplash.com/photo-1624374053855-39a5a1a41402?q=80&w=800&auto=format&fit=crop' },
      ...
      { name: 'Wings Platter', price: '17 Dhs.', img: 'https://images.unsplash.com/photo-1527477396000-e27163b481c2?q=80&w=800&auto=format&fit=crop' },
    ],
  },
  {
    ...
    items: [
      ...
      { name: 'Chicken Masala', price: '19 Dhs.', img: 'https://images.unsplash.com/photo-1631452180519-c014fe946bc7?q=80&w=800&auto=format&fit=crop' },
      ...
      { name: 'Mutton Kadai', price: '24 Dhs.', img: 'https://images.unsplash.com/photo-1574653853027-5382a3d23a15?q=80&w=800&auto=format&fit=crop' },
    ],
  },
  {
    ...
    items: [
      ...
      { name: 'Chicken Biryani', price: '15 Dhs.', img: 'https://images.unsplash.com/photo-1589302168068-964664d93dc0?q=80&w=800&auto=format&fit=crop' },
      { name: 'Mutton Biryani', price: '20 Dhs.', img: 'https://images.unsplash.com/photo-1633945274405-b6c8069047b0?q=80&w=800&auto=format&fit=crop' },
      ...
      { name: 'Egg Fried Rice', price: '17 Dhs.', img: 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?q=80&w=800&auto=format&fit=crop' },
      ...
      { name: 'Fried Rice - Schezwan (Chicken)', price: '20 Dhs.', img: 'https://images.unsplash.com/photo-1645696301019-35adaf863d8a?q=80&w=800&auto=format&fit=crop' },
      ...
      { name: 'Jeera Rice', price: '10 Dhs.', img: 'https://images.unsplash.com/photo-1596097635121-14b38c5d7a27?q=80&w=800&auto=format&fit=crop' },
      { name: 'Ghee Rice', price: '10 Dhs.', img: 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?q=80&w=800&auto=format&fit=crop' },
      { name: 'Triple Schezwan Fried Rice', price: '25 Dhs.', img: 'https://images.unsplash.com/photo-1624374053855-39a5a1a41402?q=80&w=800&auto=format&fit=crop' },
    ],
  },
  {
    category: 'Drinks',
                ...
                <div key={`${item.name}-${index}`} className="menu-item-card">
                  ...
                  <div className="menu-item-info">
                    ...
                    <div className="menu-item-footer">
                      ...
                      <motion.a
                        href={`https://wa.me/97143312767?text=${encodeURIComponent(`Hello! I'd like to order: ${item.name} (${item.price})`)}`}
                        target="_blank"
                        rel="noreferrer"
